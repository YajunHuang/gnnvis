...
__all__ = ['SparseGraph', 'save_sparse_graph_to_npz', 'load_sparse_graph_from_npz']
...
class SparseGraph(object):
    ...
    def to_undirected(self):
        ...
        if self.adj_matrix.is_weighted():
...
def save_sparse_graph_to_npz(filepath: str, sparse_graph: SparseGraph) -> None:
...
def load_sparse_graph_from_npz(filepath: str) -> SparseGraph:
    ...
    """
    with np.load(filepath) as loader:
        loader = dict(loader)
